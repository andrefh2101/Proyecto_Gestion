...
INSERT INTO `areas_conocimiento` VALUES (4,23,4),(5,16,5),(6,29,6),(7,16,7),(8,16,9),(9,30,6);
...
CREATE TABLE `entradas_subcategoria` (
  ...
  CONSTRAINT `fk_entrada_subcat` FOREIGN KEY (`subcategoria_id`) REFERENCES `nombre_subcategorias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `entradas_subcategoria` VALUES (1,1,'Acta de constitución del proyecto'),(2,1,'Plan para la dirección del proyecto'),(3,1,'Factores ambientales de la empresa'),(4,1,'Activos de los procesos de la organización');
...
CREATE TABLE `herramientas_tecnicas_subcategoria` (
  ...
  CONSTRAINT `fk_ht_subcat` FOREIGN KEY (`subcategoria_id`) REFERENCES `nombre_subcategorias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `herramientas_tecnicas_subcategoria` VALUES (1,1,'Juicio de expertos'),(2,1,'Análisis de datos'),(3,1,'Reuniones');
...
CREATE TABLE `salidas_subcategoria` (
  ...
  CONSTRAINT `fk_salida_subcat` FOREIGN KEY (`subcategoria_id`) REFERENCES `nombre_subcategorias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `salidas_subcategoria` VALUES (1,1,'Plan para la gestión del alcance'),(2,1,'Plan de gestión de los requisitos');
...
INSERT INTO `subcategorias` VALUES (2,5,1);
...
-- Dump completed on 2025-12-06  7:10:08
